...
def main():
    ...
    Symptom_1 = st.selectbox('Primary Symptom',{'Select your primary symptom':0,'Abdominal Pain':'abdominal_pain','Abnormal Menstruation':'abnormal_menstruation','Acidity':'acidity','Acute Liver Failure':'acute_liver_failure','Altered Sensorium':'altered_sensorium','Anxiety':'anxiety','Back Pain':'back_pain','Belly Pain':'belly_pain','Blackheads':'blackheads','Bladder Discomfort':'bladder_discomfort','Blister':'blister','Blood in Sputum':'blood_in_sputum','Bloody Stool':'bloody_stool','Blurred and Distorted Vision':'blurred_and_distorted_vision','Breathelessness':'breathlessness','Brittle Nails':'brittle_nails','Bruising':'bruising','Burning Micturition':'burning_micturition','Chest Pain':'chest_pain','Chills':'chills','Cold hands and feets':'cold_hands_and_feets','Coma':'coma','Congestion':'congestion','Constipation':'constipation','Continuous feel of Urine':'continuous_feel_of_urine','Continuous Sneezing':'continuous_sneezing','Cough':'cough','Cramps':'cramps','Dark Urine':'dark_urine','Dehydration':'dehydration','Depression':'depression','Diarrhoea':'diarrhoea','Dischromic Patches':'dischromic_patches','Distention of Abdomen':'distention_of_abdomen','Dizziness':'dizziness','Drying and Tingling Lips':'drying_and_tingling_lips','Enlarged Thyroid':'enlarged_thyroid','Excessive Hunger':'excessive_hunger','Extra Marital Contacts':'extra_marital_contacts','Family History':'family_history','Fast Heart Rate':'fast_heart_rate','Fatigue':'fatigue','Fluid Overload':'fluid_overload','Foul Smell of Urine':'foul_smell_ofurine','Headache':'headache','High Fever':'high_fever','Hip Joint Pain':'hip_joint_pain','History of Alcohol Consumption':'history_of_alcohol_consumption','Increased Appetite':'increased_appetite','Indigestion':'indigestion','Inflammatory Nails':'inflammatory_nails','Internal Itching':'internal_itching','Irregular Sugar Level':'irregular_sugar_level','Irritability':'irritability','Irritation in Anus':'irritation_in_anus','Itching':'itching','Joint Pain':'joint_pain','Knee Pain':'knee_pain','Lack of Concentration':'lack_of_concentration','Lethargy':'lethargy','Loss of Appetite':'loss_of_appetite','Loss of Balance':'loss_of_balance','Loss of Smell':'loss_of_smell','Malaise':'malaise','Mild Fever':'mild_fever','Mood Swings':'mood_swings','Movement Stiffness':'movement_stiffness','Mucoid Sputum':'mucoid_sputum','Muscle Pain':'muscle_pain','Muscle Wasting':'muscle_wasting','Muscle Weakness':'muscle_weakness','Nausea':'nausea','Neck Pain':'neck_pain','Nodal Skin Eruptions':'nodal_skin_eruptions','Obesity':'obesity','Pain behind the Eyes':'pain_behind_the_eyes','Pain during bowel movements':'pain_during_bowel_movements','Pain in Anal Region':'pain_in_anal_region','Painful Walking':'painful_walking','Palpitations':'palpitations','Passage of Gases':'passage_of_gases','Patches in Throat':'patches_in_throat','Phlegm':'phlegm','Polyuria':'polyuria','Prognosis':'prognosis','Prominent Veins on Calf':'prominent_veins_on_calf','Puffy Face and Eyes':'puffy_face_and_eyes','Pus Filled Pimples':'pus_filled_pimples','Receiving Blood Transfusion':'receiving_blood_transfusion','Receiveing Unsterile Injections':'receiving_unsterile_injections','Red sore around Nose':'red_sore_around_nose','Red spots on body':'red_spots_over_body','Redness of Eyes':'redness_of_eyes','Restlessness':'restlessness','Runny Nose':'runny_nose','Rusty Sputum':'rusty_sputum','Scurring':'scurring','Shivering':'shivering','Silver like dusting':'silver_like_dusting','Sinus Pressure':'sinus_pressure','Skin Peeling':'skin_peeling','Skin Rash':'skin_rash','Slurred Speech':'slurred_speech','Small dents in nails':'small_dents_in_nails','Spinning Movements':'spinning_movements','Spotting Urination':'spotting_urination','Stiff Neck':'stiff_neck','Stomach Bleeding':'stomach_bleeding','Stomach Pain':'stomach_pain','Sunken Eyes':'sunken_eyes','Sweating':'sweating','Swelled Lymph Nodes':'swelled_lymph_nodes','Swelling Joints':'swelling_joints','Swelling of Stomach':'swelling_of_stomach','Swollen Blood Vessels':'swollen_blood_vessels','Swollen Extremeties':'swollen_extremeties','Swollen Legs':'swollen_legs','Throat Irritation':'throat_irritation','Toxic Look (Typhos)':'toxic_look_(typhos)','Ulcers on Tongue':'ulcers_on_tongue','Unsteadiness':'unsteadiness','Visual Disturbances':'visual_disturbances','Vomiting':'vomiting','Watering from Eyes':'watering_from_eyes','Weakness in Limbs':'weakness_in_limbs','Weakness in one side of body':'weakness_of_one_body_side','Weight Gain':'weight_gain','Weight Loss':'weight_loss','Yellow Crust Ooze':'yellow_crust_ooze','Yellow Urine':'yellow_urine','Yellowing of Eyes':'yellowing_of_eyes','Yellowish Skin':'yellowish_skin'})
