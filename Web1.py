...
def main():
    ...
    Symptom_1 = st.selectbox('Primary Symptom',{'Select Your Primary Symptom':NULL,'Vomiting':'vomiting','Shivering':'shivering'})
    ...
    if st.button("About"):
        st.text("This is just a prototype, when in need please consult a doctor.")
